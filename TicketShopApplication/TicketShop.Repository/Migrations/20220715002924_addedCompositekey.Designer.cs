...
namespace TicketShop.Repository.Migrations
{
    ...
    [Migration("20220715002924_addedCompositekey")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketShop.Domain.DomainModels.Ticket", b =>
                {
                    ...
                    b.Property<DateTime>("VallidTill")
            ...
            modelBuilder.Entity("TicketShop.Domain.Identity.TicketShopAppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TicketShop.Domain.Identity.TicketShopAppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TicketShop.Domain.DomainModels.Order", b =>
                {
                    b.HasOne("TicketShop.Domain.Identity.TicketShopAppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("TicketShop.Domain.DomainModels.ShoppingCart", b =>
                {
                    b.HasOne("TicketShop.Domain.Identity.TicketShopAppUser", "Owner")
                        .WithOne("UserCart")
